...
# %% auto 0
__all__ = ['Abstract_Env', 'Cyclic_Env', 'Noisy_Cycle', 'RLGL', 'Causal_DBN', 'HMM', 'Light_And_Lever']
...
# %% ../nbs/lib_nbs/03_environments.ipynb 18
import inspect
...
# %% ../nbs/lib_nbs/03_environments.ipynb 23
class HMM(Abstract_Env):
    def __init__(self,
                 ...
                 transition_function: np.ndarray, #An NxN array, rows contain probability distributions
                 initial_state: int = 0
                ):
        assert isinstance(percepts, np.ndarray)
        if percepts.ndim == 1:
